  ...
  return (
    ...
    <div className='flex flex-col md:flex-row lg:flex-row justify-center align items-center mt-4 p-4'>
        <div>
            ...
            <button className='bg-main text-white font-semibold border-sm p-1 mt-4 ml-36'>Shop Now</button>
        </div>
      <div>
        <Image src="/image/sofa copy.png" alt="discount product" width={400} height={400} /> 
        </div>
    </div>
    </div>
  )
