...
<div className="relative md:absolute top-[-110px] left-[-50px]">
  <Image src="/image/bulb.png" alt="Bulb" width={300} height={100} className="object-contain" />
</div>
      ...
      <div className="w-full md:w-1/2 h-full relative flex flex-col items-center justify-start">
        ...
        <div
          ...
          style={{ backgroundImage: 'url(/image/pink.png)' }}
        ></div>

        {/* Sofa Image */}
        <div className="relative z-10 mt-[80px] mb-[20px]">
          <Image src="/image/sofa.png" alt="Sofa" width={350} height={250} className="object-contain" />
        </div>

        {/* Blue Discount Badge */}
        <div
          className="absolute top-[40px] right-[240px] bg-cover bg-center w-[80px] h-[80px] flex flex-col justify-center items-center z-20"
          style={{ backgroundImage: 'url(/image/discount.png)' }}
        >
