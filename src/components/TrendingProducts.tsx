...
function TrendingProducts() {
  const products = [
    { id: 1, img: "/image/chair5.png" },
    { id: 2, img: "/image/chair6.png" },
    { id: 3, img: "/image/chair7.png" },
    { id: 4, img: "/image/product5.png" },
  ];

  const exclusiveProducts = [
    { id: 1, img: "/image/chair8.png" },
    { id: 2, img: "/image/chair9.png" },
    { id: 3, img: "/image/chair10.png" },
  ];
