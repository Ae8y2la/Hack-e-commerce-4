...
function TopCategories() {
  const categories = [
    { id: 1, img: "/image/chair3.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 2, img: "/image/chair.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 3, img: "/image/chair5.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 4, img: "/image/chair1.png", name: "Mini LCW Chair", price: "$56.00" },
  ];
